...
const Projects = () => {
  const projects = [
    {
      title: 'HaveaTalk',
      description: 'Full-stack real-time collaboration platform with authentication, chat, video calls, and screen sharing. Built from scratch with 4000+ lines of code in 20-25 days.',
      tech: ['MongoDB', 'Express.js', 'React', 'Node.js', 'Tailwind CSS', 'Strean API & SDKs'],
    ...
    },
    {
      ...
      description: 'React-based application displaying comprehensive country data including population, languages, and more using a public API. Features advanced search and filtering capabilities.',
    ...
    {
      title: 'Kamboj Store',
      description: 'E-commerce website with custom API integration and fully responsive design. Implements modern UI/UX principles for optimal shopping experience.',
    ...
    },
    {
      ...
      description: 'React application demonstrating full CRUD functionality with Axios for API communication. Clean and intuitive interface for data management.',
